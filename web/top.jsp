            ...
            <ul>
                ...
                <div class="search_total_midd">
                  <div class="search_lft">
                    ...
                    <input type="text" value="Search Products..." name="search" class="fl" onfocus="if (this.value=='Search Products...') this.value='';" onblur="if (this.value=='') this.value='Search Products...'" id="search" maxlength="300">
                     </form>
                  </div>
