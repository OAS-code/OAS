...
<html>
    ...
    <body>        
        ...
        <div class="feature_total">
            <div id="auction_502" class="auction_item auction_item_content" name="http://www.unieauction.com/platinum-demo/auctions/process" data-id="502">
                ...
                <div class="feature_box">
                    ...
                    <div class="feature_rgt">
                        <label><a href="http://www.unieauction.com/platinum-demo/auctions/view/monitorE6Ol1" title="Monitor">
                    ...
                    <div class="feature_bott">
                        <div class="feature_bott_lft">
                            ...
                            <a title="+ Add to Watchlist" rel="502" class="addwatchlist" name="http://www.unieauction.com/platinum-demo/auctions/addwatchlist"><img src="http://www.unieauction.com/platinum-demo/public/white/images/plus_bg.png" width="24" height="25" alt="+ Add to Watchlist"></a>
                        </div>
                        <div class="feature_bott_rgt" style="margin:0 10px 0 0;">
                            <div class="bidme_link">
                                <div class="bidnow_lft"></div>
                                <div class="bidnow_mid">
                                    <p>  <a href="javascript:;" name="http://www.unieauction.com/platinum-demo/auctions/bid/502" class="bid" title="BID NOW" rel="http://www.unieauction.com/platinum-demo/users/login/" id="502" data-auctiontype="25">
                                            BID NOW                                        </a></p>
                                </div>
            ...
            <div class="user" style="display:none;">334</div>
            ...
            <div class="today_head">
                ...
                <div class="arrow_one"></div>
                <div class="today_head_rgt">
                    <p><a href="http://www.unieauction.com/platinum-demo/auctions/future" title="View All">View All</a></p>
                </div>
            </div>
            <div class="feature_total">
                ...
                <div id="auction_603" class="auction_item auction_item_content" name="http://www.unieauction.com/platinum-demo/auctions/process">
                    <div class="auction_type" data-auctiontype="25"></div>
                    <div class="feature_left_box"> <div class="auction_lft">

                            <a href="http://www.unieauction.com/platinum-demo/auctions/view/handbag" title="Handbag" class="fl">
                        ...
                        <div class="auction_rgt">
                            <label>  <a href="http://www.unieauction.com/platinum-demo/auctions/view/handbag" title="Handbag">
                                    Handbag                        </a></label>
                            <ul>
                                <li> 
                        ...
                        <div class="auction_bott">
                            ...
                            <div class="feature_bott_lft" style="width:346px;">
                                ...
                                <a title="+ Add to Watchlist" rel="603" class="addwatchlist" name="http://www.unieauction.com/platinum-demo/auctions/addwatchlist"><img src="http://www.unieauction.com/platinum-demo/public/white/images/plus_bg.png" width="24" height="25" alt="+ Add to Watchlist"></a>
