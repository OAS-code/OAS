...
function checkFullname(){
    var fullname = document.forms["editUserForm"]["fullname"].value;
...
function checkPhonenumber(){
    var phone = document.forms["editUserForm"]["phonenumber"].value;
    if (phone.length > 50) {
...
function checkAddress(){
    var address = document.forms["editUserForm"]["address"].value;
